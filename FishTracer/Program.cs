namespace FishTracer
{
    ...
    class Program
    {
        ...
        public static void Main()
        {
            ...
            Metal materialLeft = new Metal(new Vector3(0.8,0.8, 0.8), 0.05);
            ...
            RayCaster rayCaster = new RayCaster("RC", 1000, 4, 16.0/9.0, 1);
            sw.Restart();
            ...
            Console.WriteLine($"RandomNumbers={Vector3.RndNum}");
            rayCaster.window.Update(true);
